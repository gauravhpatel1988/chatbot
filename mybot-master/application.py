...
from dateTime import getTime, getDate, getos, getfilesystem

##OS details

from unix import getos,getfilesystem,getcpuinfo
...
def get_bot_response():
    ...
    if botReply is "IDKresponse":
        ...
        botReply = getos()
        print( getos())
    elif botReply == "getfilesystem":
        botReply = os.system("df -h")
    return botReply
